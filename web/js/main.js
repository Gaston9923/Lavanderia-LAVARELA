...
$(document).ready(function() {    
     $('#tablaRegistros').DataTable({
        ...
        buttons:[ 
			{
				extend:    'excelHtml5',
				text:      '<i id="btnAccion" class="fas fa-file-excel"></i> ',
				titleAttr: 'Exportar a Excel',
				className: 'btn btn-success'
			},
			{
				extend:    'pdfHtml5',
				text:      '<i id="btnAccion" class="fas fa-file-pdf"></i> ',
				titleAttr: 'Exportar a PDF',
				className: 'btn btn-danger'
            },
            {
				extend:    'print',
				text:      '<i id="btnAccion" class="fa fa-print"></i> ',
				titleAttr: 'Imprimir',
				className: 'btn btn-info'
            },
            {
                extend: 'colvis',
                text:      '<i id="btnAccion" class="fa fa-list-alt"></i> ',
