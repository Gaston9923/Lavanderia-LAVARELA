...
@WebServlet(name = "rIngresosServlet", urlPatterns = {"/rIngresosServlet"})
public class rIngresosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("\\WEB-INF\\rIngresos.jasper"));
