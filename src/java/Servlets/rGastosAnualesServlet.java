...
@WebServlet(name = "rGastosAnualesServlet", urlPatterns = {"/rGastosAnualesServlet"})
public class rGastosAnualesServlet extends HttpServlet {
    ...
    try {
            ...
            JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("\\WEB-INF\\rGastoAnual.jasper"));
